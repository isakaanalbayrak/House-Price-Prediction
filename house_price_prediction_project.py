...
# Task
# I need to develop a machine learning model that predicts house prices with minimal error using the provided dataset and submit my predictions to the Kaggle competition.
...
################################################################
# Step 1: Read the train and test datasets and merge them. Proceed with the merged data.
################################################################
...
def num_summary(dataframe, numerical_col, plot=False):
    quantiles = [0.05, 0.10, 0.20, 0.30, 40, 0.50, 0.60, 0.70, 0.80, 0.90, 0.95, 0.99]
...
# In some variables, missing values indicate that the house does not have that feature
...
# This function fills missing values with the median or mean
...
######################################
# Create new variables and add 'NEW' prefix to their names.
######################################
...
# Dropping the variables in the drop_list
...
# Separate the train and test data. The values with missing SalePrice are the test data.
...
# Build the model using the training data and evaluate its performance.
...
##################
# BONUS: Build a model using log transformation and observe the RMSE results.
# Note: Don’t forget to take the inverse of the log.
##################
...
# Taking the inverse of the log transformation
...
################################################################
# Plot the feature importance using the feature_importance function and rank the features.
################################################################
...
########################################
# Predict the missing SalePrice values in the test dataframe and create a dataframe suitable for Kaggle submission. (Id, SalePrice)
########################################
